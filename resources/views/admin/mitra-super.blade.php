            ...
            <form action="/mitra-admin/store"  method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="fasilitas" class="form-control" id="fasilitas" placeholder="Fasilitas" rows="3" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="norek" class="form-control" id="norek" placeholder="Nomor Rekening (Harap Masukkan no rekening dengan benar!)" required="">
                    </div>
                    <div class="form-group">
