...
<head>
  ...
  <title>Admin Sports | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Admin | Sports</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                  <a href="/artikel-admin" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                        <p>Data Artikel</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/artikel-admin-create" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tambah Artikel</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/artikel_category" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="/mitra-super" class="nav-link">
                                <p>
                                    kelola Perusahaan
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="/sarana-admin" class="nav-link">
                                <p>
                                    kelola Sarana
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="/notifikasi" class="nav-link">
                                <p>
                                    kelola Notifikasi untuk member
                                </p>
                            </a>
                        </li>
                        <li class="nav-item">
