...
<html lang="en">
  <head>
    ...
    <title>Sports | Travel Management System</title>

    <!-- Bootstrap -->
    <link href="{{ url("/assets/backend/vendors/bootstrap/dist/css/bootstrap.min.css") }}" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="{{ url("/assets/backend/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css") }}" rel="stylesheet">
    <link href="{{ url("/assets/backend/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css") }}" rel="stylesheet">
    <link href="{{ url("/assets/backend/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css") }}" rel="stylesheet">
    @yield('css')
      ...
      <div class="main_container">
        ...
        <footer>
          <div class="pull-right">
            Copyright by <a href="https://www.polindra.ac.id/">Kelompok 7 Polindra</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
