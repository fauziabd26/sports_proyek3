...
class ArticleCategoryController extends Controller
{
    public function index(){
        ...
        return view('backend.article_category.view',compact('category'));
    }
    ...
    public function destroy($id){
        try {
            ...
            return redirect('/artikel_category')->with('alert-success', 'Data berhasil dihapus!');
        } catch (\Throwable $th) {
            return redirect('/artikel_category')->withErrors('Data gagal Dihapus');
        }
    }
}
